        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="{{ route('home') }}" class="text-decoration-none ml-5">
                    ...
                    @foreach ($settings as $setting)
                        <img class="" src="{{ asset($setting->logo) }}" alt="" height="70 px"
                            width="150 px">
                    @endforeach
            ...
            <div class="col-lg-12 ">
                <nav class="navbar navbar-expand-lg   py-3 py-lg-0 px-0">
                    <a href="{{ route('home') }}" class="text-decoration-none d-block d-lg-none">
                        <img class="" src="{{ asset('/') }}website/img/637b709aa4a83.png" alt=""
                            height="70 px" width="150 px">
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0 ">
                            <a href="{{ route('home') }}"
                                class="nav-item hoba nav-link text-white fw-bold active">Home</a>
                            <a href="{{ route('hotdeal') }}"
                                class="nav-item hoba nav-link text-white fw-bold active">Shop</a>

                            @foreach ($categories as $category)
                                <a href="{{ route('category', ['id' => $category->id]) }}"
                                    class="nav-item hoba nav-link text-white fw-bold">{{ $category->name }}</a>
                            @endforeach
                    ...
                    <div class="col-10 mx-auto">
                        <div class="row text-white">
                            <div class="col-md-3 px-4">
                                <img class="mb-3" src="{{ asset($setting->logo) }}" alt="" height="70 px"
                                    width="150 px">
                                <p>{!! $setting->footer_description !!}</p>
                                <p>Follow Us</p>
                                <a href="{{ $setting->facebook }}" target="_blank" class="p-3 bg-success rounded "><i
                                        class="fa-brands fa-facebook-f text-white "></i></a>
                                <a href="{{ $setting->instragram }}" target="_blank" class="p-3 bg-success rounded"><i
                                        class="fa-brands fa-instagram  text-white"></i></a>
                                <a href="{{ $setting->youtube }}" target="_blank" class="p-3 bg-success rounded"><i
                                        class="fa-brands fa-youtube  text-white"></i></a>
                            </div>
                            <div class="col-md-3  px-2"> <b>Contact Us</b>
                                <address class="mt-3">
                                    {!! $setting->contact !!}
                                </address>
                            </div>
                            <div class="col-md-3  px-5"> <b>Information</b>
                                <ul class="navbar-nav mt-3">
                                    <li> <a href="{{ route('information') }}" class="nav-link text-white">Privacy
                                            Policy</a></li>
                                    <li><a href="{{ route('return') }}" class="nav-link text-white">Return Policy</a>
                                    </li>
